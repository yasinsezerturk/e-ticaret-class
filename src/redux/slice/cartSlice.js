////sepetteki ürünlerin kaydını yöneten redux : carta ürün ekleme ve artırma,
// cartan ürün çıkarma ve azaltma, cartı temizleme, cart ürün sayısı , toplam fiyat
  ...
  reducers: {
    ...
    DECREASE_CART(state, action) {
      ...
      if (state.cartItems[productIndex].cartQuantity > 1) {
        state.cartItems[productIndex].cartQuantity -= 1;
        toast.info(`${action.payload.name} descreased by one`, {
          position: "top-left",
        });
